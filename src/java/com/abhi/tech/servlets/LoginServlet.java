...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (u == null) {
               /////////////////// login error/////////////////////// 
//                out.println(" Wrong Details , Try Again");
                String content = "Invaild Details ! Please try Again ";
                String type = " You should check in on some of those fields below.";
                String cssClass = "alert-danger";
                Message msg = new Message(content, type, cssClass);
                // For sending this message to login_jsp page 
